...
const exp = [
  {
    ...
    cardImage: "assets/images/experience-page/bukitasam.png",
    place: "Bukit asam",
    time: "(february-May, 2022 )",
    desp: "<li>create a prototype of an application.</li></li><li>created a user interface mobile apps.</li> <li>connect mobile app with api.</li> ",
  },
